...
; Compile with: nasm -f elf stringlength.asm
; Link with (64 bit systems require elf_i386 option): ld -m elf_i386 stringlength.o -o stringlength
; Run with: ./stringlength
