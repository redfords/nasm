...
; Compile with: nasm -f elf includefunctions.asm
; Link with (64 bit systems require elf_i386 option): ld -m elf_i386 includefunctions.o -o includefunctions
; Run with: ./includefunctions
